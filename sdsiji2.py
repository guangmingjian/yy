...
def yuhun(iter):
    ...
    while (counter < iter):
        ...
        btnx,btny = BM.iterfindpic(imgroot+ "dajiutouxiang2"+imgtype,confi=0.8,internaltime=0.1,mosttime=endIter)
        time.sleep(0.2)
        pag.click(364,620 + random.randint(-10,10),duration=0.2)
