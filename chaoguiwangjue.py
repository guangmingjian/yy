...
def yuhun(iter):
    ...
    while (counter < iter):
        ...
        if btnx == -1 or btny == 0:
            ...
            time.sleep(2)
            btnx1,btny1 = BM.findpic("image/faxianguiwang.png",confi=0.8)
            if btnx1 > 0 :
                pag.click(btnx1,btny1)
                time.sleep(6)
                btnx1, btny1 = BM.findpic("image/guiwang/guiwangtiaozhan.png", confi=0.8)
                while btnx1 > 0:
                    pag.click(btnx1, btny1)

                    btnx1, btny1 = BM.iterfindpic(imgroot2 + "zhunbei" + imgtype, confi=1, internaltime=0.1, mosttime=endIter)
                    pag.click(btnx1, btny1, duration=0.01)
                    ...
                    btnx1, btny1 =BM.iterfindpic("image/shengli.png",0.8, internaltime=0.1, mosttime=endIter)

                    pag.click(btnx1, btny1, duration=0.01)

                    BM.jiancha("image/shengli.png", 1, btnx1, btny1, 1)

                    time.sleep(5)
                    btnx1, btny1 = BM.findpic("image/guiwang/guiwangtiaozhan.png", confi=0.8)
                btnx1, btny1 = BM.findpic("image/guiwang/fanhui.png", confi=0.8)
                pag.click(btnx1, btny1)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/juexingcailiao.png", 0.8, internaltime=0.1, mosttime=endIter)
                pag.click(btnx1, btny1)
                time.sleep(2)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/huoqilin.png", 0.8, internaltime=0.1,
                                              mosttime=endIter)
                pag.click(btnx1 + random.randint(-5, -5), btny1)
                time.sleep(2)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/zudui.png", 0.8, internaltime=0.1,
                                              mosttime=endIter)
                pag.click(btnx1+random.randint(-5,-5), btny1)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/shiceng.png", 0.8, internaltime=0.1,
                                              mosttime=endIter)
                pag.click(btnx1 + random.randint(-5, -5), btny1)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/chuangjianduiwu.png", 0.8, internaltime=0.1,
                                              mosttime=endIter)
                pag.click(btnx1 + random.randint(-5, -5), btny1)
                btnx1, btny1 = BM.iterfindpic("image/guiwang/chuangjian.png", 0.8, internaltime=0.1,
                                              mosttime=endIter)
                pag.click(btnx1 + random.randint(-5, -5), btny1)
                btnx, btny = iterFind("kaishizhandou", beginInterval=beginfightInterval, iternum=500)
        ...
        BM.guiwangshengliandjieshu(endIter)
        # # 开始查找胜利
